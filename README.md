...
Analísta de datos con amplia experiencia en producción animal, amante de la naturaleza, los viajes, la buena comida y el mar.
...
- Culmine mis estudios de Data Analyst en Laboratoria, en donde adquirí conociemientos en el manejo de los datos (ETL, BigQuery (SQL), PowerBI, Looker studio, Python).
